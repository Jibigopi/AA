		...
		<div id="wrapper_all">
			...
			<section class="container clearfix main_section">
				<div id="main_content_outer" class="clearfix">
					<div id="main_content">
					<h5 class="btn btn-success">UPDATE CUSTOMER</h5>
							...
							<div class="col-sm-12">
								<div class="panel panel-default">
										 ...
										 <?php foreach ($row as $g_row){ ?>
                                                                         ...
                                                                         echo form_open('dashboard/update_customers',$form);?>
