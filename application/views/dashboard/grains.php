...
<head>
	...
	$(document).ready(function() {
        ...
        null, null, null, null, null, 
             ...
             if(result){
            $.ajax({
                url: '<?php echo base_url() ?>index.php/dashboard/grains_delete',
                type: "POST",
                data: {
                    guid: guid
				...
				<div class="container">
					...
					<li>
						...
						<ul>  
                                                    ...
                                                    <li>   <a href="<?php  echo base_url()?>index.php/customer_category">Category</a></li>
						</ul>
					</li>
					<li>
						...
						<ul>  
                                                    ...
                                                    <li>   <a href="<?php  echo base_url()?>index.php/grains_category">Category</a></li>
						</ul>
					</li>
					<li >
						<a href="javascript:void(0)">Stock</a>
						<ul>  
                                                    <li>  <a href="<?php  echo base_url('index.php/stage')?>">Stock Stage</a></li><li>
                                                   <a href="<?php  echo base_url('index.php/stock')?>">Stock</a></li>
						</ul>
					</li>
						...
						<ul>  
                                        ...
                                        <li >
						<a href="<?php  echo base_url()?>index.php/dashboard/sales">Add Sales</a>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="panel panel-default">
                                                                    <a href="<?php echo base_url() ?>index.php/dashboard/add_grain" class="btn btn-success"><i class="icon icon-plus"></i> ADD</a>
	...
	<!-- ebro common scripts/functions -->
	 ...
	 <script src="<?php echo base_url() ?>admin/data_table/js/bootbox.min.js"></script>
...
<!-- datatables -->
    ...
    <!-- style switcher -->
     ...
     <script type="text/javascript">
                    function delete_selected_grains(){
                      var flag_d=0;
                     ...
                     var field=document.forms.grains;
                      ...
                      if (flag<1) {
                         bootbox.alert("Please Select Grain To Delete");
