        ...
        <!-- Header-->
         ...
         <div class="row" style="margin-top:15px; ">
             <div class="col col-lg-12">
                 <h2 class="font text-center"><img src="<?php echo base_url() ?>images/divider_left_h.png" style="padding-right: 50px;"> FORGET PASSWORD <img src="<?php echo base_url() ?>images/divider_right_h.png" style="padding-left: 50px;"></h2>
             </div>
         </div>
         <div class="row home_contant" style="margin-top:15px; ">
             ...
             <div class="col col-lg-4 tex-center" style="margin-left: 12px">
                 <div class="font text-center" style="font-size:14px;color: red "><?php echo validation_errors(); ?><br>
                 <?php echo $msg; ?></div>
	   <!-- Form itself -->
           <form name="sentMessage" action="<?php echo base_url() ?>index.php/admin/get_forget_password" id="contactForm" method="post"  novalidate>
             
		 <div class="control-group">
                    <div class="controls">
			<input type="text" name="email" class="form-control" 
			   	   placeholder="EMAIL" id="username" required
			           data-validation-required-message="PLEASE ENTER REGISTRED" />
	     ...
	     <div id="success"> </div> <!-- For success/fail messages -->
             <input type="submit" name="submit" class="btn   font " value="SUBMIT">
          </form>
	</div>
