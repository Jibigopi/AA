								...
								<div class="modal-content">
									<form id="parsley_reg" action="post" onsubmit="false">
										<div class="modal-header">
											...
											<h4 class="modal-title" id="myModalLabel">ADD NEW SALES</h4>
										</div>
										<div class="modal-body">
												...
												<div class="form-group">
													   <label ><br></label>
												 <?php $invoice_number=array('name'=>'invoice_number',
                                                                                                            'class'=>'form-control invoice_number',
                                                                                                            'id'=>'invoice_number',
                                                                                                            'data-required'=>'true',
                                                                                                            'value'=>set_value('invoice_number'));
                                                                                                            echo form_input($invoice_number)?>          
											...
											<div class='col col-lg-4'>										
												<div class="form-group text-center">
												<label for="button">&nbsp</label>
													<button type="submit" class="btn btn-primary" id="add_new_sales_by_search">ADD SALE</button>        
												</div>	
											</div>
                                                                                        </div>
