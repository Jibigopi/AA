	...
	$(document).ready(function() {
	 ...
	 sales_channel_form.onsubmit=function()
            ...
            $('input.destination').typeahead({
					name: 'destination',
					remote : '<?php echo base_url() ?>index.php/product_details/product_category/%QUERY'
			});
        ...
        null, null, null, null, 
                 ...
                 $("#add_new_product").click(function() {
				  ...
				  $.ajax ({
					url: "<?php echo base_url('index.php/product_details/add_new_product')?>",
					data: inputs,
                                        type:'POST',
                 ...
                 $("#add_product_update").click(function() {
				  ...
				  $.ajax ({
					url: "<?php echo base_url('index.php/product_details/update_product')?>",
					data: inputs,
                                        type:'POST',
					complete: function(response) {                                    
                                        if(response['responseText']=='TRUE'){
                 ...
                 $("#add_sales_channel").click(function() {
				  ...
				  $.ajax ({
					url: "<?php echo base_url('index.php/product_details/sales_channel')?>",
					data: inputs,
                                        type:'POST',
					complete: function(response) {                                    
                                        if(response['responseText']=='TRUE'){
            ...
            $.ajax({
                ...
                function update_product(sid){
                        $("#product_update_form").trigger('reset');
                        $.ajax({                                      
			  url: "<?php echo base_url() ?>index.php/product_details/edit_product_details/"+sid,                      
			  data: "",     						 
			  dataType: 'json',               
...
//                                }
                    ...
                    function upload_product_image(guid){
                        $.ajax({                                      
			  url: "<?php echo base_url() ?>index.php/product_details/edit_product_details/"+guid,                      
			  data: "",     						 
			  dataType: 'json',               
			  success: function(data)     
			  {
			  ...
			  success: function(data)     
			  {
               ...
               function set_sales_chanel(guid){
                        $.ajax({                                      
			  url: "<?php echo base_url() ?>index.php/product_details/get_sales_channel/"+guid,                      
			  data: "",     						 
			  dataType: 'json',               
			  success: function(data)     
			  {
            ...
            function product_number(){
                     $.ajax({                                      
			  url: "<?php echo base_url() ?>index.php/product_details/generate_number/",                      
			  data: "",                       
