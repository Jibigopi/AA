						...
						<div class="row">
							<div class="col-sm-12">
								<div class="panel panel-default">
										 ...
										 <?php foreach ($row as $g_row){ ?>
                                                                                    <?php   $form =array('id'=>'parsley_reg'
                                                                                              );
                                                                         echo form_open('dashboard/update_grain',$form);?>
                                                                       <input type="hidden" name="guid" value="<?php echo $g_row->id ?>">
											...
											<div class="form_sep">
												...
												<label for="category" class="req">Category</label>												
                                                                                                <select class="form-control" name="category">
                                                                                                    <?php 
                                                                                    foreach ($cat as $row) {?>
                                                                                                    <option value="<?php echo $row->name ?>" <?php if($g_row->cat_name===$row->name){?> selected="selected" <?php } ?>><?php echo $row->name ?></option><?php }?>
                                                                                                </select>
											</div>
											</div>
                                                                                    <div class="col col-lg-4">
