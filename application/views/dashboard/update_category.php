...
<head>
	...
	<script type="text/javascript" language="javascript" src="<?php echo base_url() ?>admin/data_table/s/jquery.js"></script>
						...
						<div class="row">
							<div class="col-sm-12">
										 <?php foreach ($row as $g_row){ ?>
                                                                         ...
                                                                         echo form_open('dashboard/update_category',$form);?>
                                                                       <div class="row">
                                                                           <input type="hidden" value="<?php echo $g_row->id ?>" name="guid">
