...
<head>
	...
	$(document).ready(function() {
           ...
           $('#dt_table_tools').dataTable({
                                      "bProcessing": true,
				      "bServerSide": true,
                                      "sAjaxSource": "<?php echo base_url() ?>index.php/dashboard/category_data_table",
                                       aoColumns: [  
        ...
        null,null,
             ...
             if(result){
            $.ajax({
                url: '<?php echo base_url() ?>index.php/dashboard/category_delete',
                type: "POST",
                data: {
                    guid: guid
                ...
                {
                    if(response){
                      bootbox.alert('Category Deleted');
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="panel panel-default">
                                                                    <a href="<?php echo base_url() ?>index.php/dashboard/add_category" class="btn btn-success"><i class="icon icon-plus"></i> ADD</a>
        ...
        <script type="text/javascript">
                    function delete_selected_customer(){
                     ...
                     var field=document.forms.grains;
                      ...
                      if (flag<1) {
                         bootbox.alert("Please Select Category To Delete");
